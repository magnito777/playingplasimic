...
import sty from "./PlasmicButton.module.css"; // plasmic-import: UQg9W3L-sZZtS/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__jbG2R)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___0GteD)}
                role={"img"}
              />
            ),
