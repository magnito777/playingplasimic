...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: Su99w8Vhz2QBBN/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__kz6Yq)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__r5Iup)}>
            <h5
